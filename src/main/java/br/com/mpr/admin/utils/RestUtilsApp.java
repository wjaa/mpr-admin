 ...
 */
@Component
public class RestUtilsApp {


    private static final Log LOG = LogFactory.getLog(RestUtilsApp.class);
    ...
    public static <T>T getJsonWithParamPath(Class<T> clazzReturn, String targetUrl, String ... params) throws
        ...
        try {
            HttpGet httpGet = new HttpGet( targetUrl + "/" + RestUtilsApp.createParamsPath(params));
    ...
    public static String get(String url, String ... params) throws
        ...
        CloseableHttpResponse response = null;
        try {
            HttpGet httpGet = new HttpGet( url + "/" + RestUtilsApp.createParamsPath(params));
            httpGet.addHeader("Authorization", "Bearer " + getToken());
            response = httpclient.execute(httpGet);
            int statusCode = response.getStatusLine().getStatusCode();
    ...
    public static <T>T putJson(Class<T> clazzReturn, String targetUrl, String uri, String json) throws RestException {
        ...
        try {
            ...
            httpPut.addHeader("Authorization", "Bearer " + getToken());
    ...
    public static <T>T delete(Class<T> clazzReturn, String targetUrl, String ... params) throws
        ...
        CloseableHttpResponse response = null;
        try {
            HttpDelete httpDelete = new HttpDelete( targetUrl + "/" + RestUtilsApp.createParamsPath(params));
    ...
    public static <T>T post(Class<T> clazzReturn, String targetUrl, String ... params) throws
        ...
        CloseableHttpResponse response = null;
        try {
            HttpPost httpPost = new HttpPost( targetUrl + "/" + RestUtilsApp.createParamsPath(params));
            httpPost.addHeader("Authorization", "Bearer " + getToken());
            response = httpclient.execute(httpPost);
            int statusCode = response.getStatusLine().getStatusCode();
    ...
    private static String getToken() throws RestException {
        ...
        if (token == null || token.isExpires()){
            ...
            try {
                ...
                token = executePostToken(httpPost);
            }catch(RestException ex){
                throw ex;
            }catch(Exception ex){
                LOG.debug("m=getToken Erro ao buscar o token",ex);
                try{
